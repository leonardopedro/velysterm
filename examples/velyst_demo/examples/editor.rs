...
fn setup(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    let handle = asset_server.load("typst/editor.typ");
...
fn find_text_index_in_frame(
    ...
    use velyst::typst::layout::{FrameItem, Point};
    let target = Point::new(
        velyst::typst::layout::Abs::pt(pos.x as f64),
        velyst::typst::layout::Abs::pt(pos.y as f64),
    );
...
fn get_glyph_position_at_byte_index(
    ...
    use velyst::typst::layout::FrameItem;
